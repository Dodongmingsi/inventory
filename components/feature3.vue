...
const images = ref([
  { src: '/images/shave.jpg', alt: 'Coke', text: 'Shave now' },
  { src: '/images/maleshampoo.jpg', alt: 'Makeup', text: 'Clean your hair' },
  { src: '/images/harry.jpg', alt: 'Kitchen', text: 'Protects you!' }
]);
...
onMounted(() => {
  intervalId = setInterval(switchImage, 2800);
});
